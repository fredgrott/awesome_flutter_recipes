...
import 'package:mdthree_two/src/presentation/app/widgets/destinations.dart';
import 'package:mdthree_two/src/presentation/app/widgets/navigation_transition.dart';
import 'package:mdthree_two/src/presentation/app/widgets/one_two_transition.dart';
import 'package:mdthree_two/src/presentation/app/widgets/update_themes.dart';
import 'package:mdthree_two/src/presentation/features/color/color_palettes_screen.dart';
import 'package:mdthree_two/src/presentation/features/components/first_component_list.dart';
import 'package:mdthree_two/src/presentation/features/components/second_component_list.dart';
import 'package:mdthree_two/src/presentation/features/components/widgets/navigation_bars.dart';
import 'package:mdthree_two/src/presentation/features/elevations/elevation_screen.dart';
...
class _MyAppState extends State<MyApp> with SingleTickerProviderStateMixin {
  ...
  FlexScheme flexSchemeSelected = FlexScheme.materialBaseline;
  ...
  void handleColorSelect(int value) {
    setState(() {
      flexSchemeSelected = ColorSeedFlex.values[value].scheme;
      themeData = updateThemes(
        flexSchemeSelected,
        useMaterial3,
        useLightMode,
  ...
  Widget colorSeedButton(Icon icon) => PopupMenuButton(
        ...
        itemBuilder: (context) {
          ...
          // ignore: prefer-extracting-callbacks
          return List.generate(ColorSeedFlex.values.length, (index) {
            final ColorSeedFlex currentColor = ColorSeedFlex.values[index];
              ...
              child: Wrap(
               children: [
                Padding(
                  ...
                  child: Icon(
                    currentColor == flexSchemeSelected ? Icons.color_lens : Icons.color_lens_outlined,
                    color: useLightMode ? currentColor.lightColor : currentColor.darkColor,
                  ),
