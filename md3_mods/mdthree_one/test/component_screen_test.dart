...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final RenderBox box = tester.renderObject(find.widgetWithText(
        NavigationBar,
        'Components',
      ),);
      expect(
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final BuildContext defaultCard = tester.firstElement(find.widgetWithText(
        Card,
        'Elevated',
      ),);
      final BuildContext defaultChip = tester.firstElement(find.widgetWithText(
        ActionChip,
        'Assist',
      ),);
      ...
      final BuildContext updatedChip = tester.firstElement(find.widgetWithText(
        ActionChip,
        'Assist',
      ),);
