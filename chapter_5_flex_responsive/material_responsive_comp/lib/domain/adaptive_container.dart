  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (
        ...
        return constraints.withinAdaptiveConstraint(context) ? Container(alignment: alignment, padding: padding, color: color, decoration: decoration, foregroundDecoration: foregroundDecoration, height: height, margin: margin, transform: transform, clipBehavior: clipBehavior, child: child) : LimitedBox(maxWidth: 0.0, maxHeight: 0.0, child: ConstrainedBox(constraints: const BoxConstraints.expand()));
      },
    );
  }
}
